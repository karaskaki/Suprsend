import React__default, { createContext, useContext, useState, useEffect, createElement } from 'react';
...
var InboxContext = createContext({});
var InboxThemeContext = createContext({});
function useInbox() {
...
var EmptyNotificationIcon = function EmptyNotificationIcon(props) {
  return /*#__PURE__*/createElement("svg", _extends({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), /*#__PURE__*/createElement("ellipse", {
    cx: 92.32,
    cy: 56.616,
    rx: 60.32,
    ry: 56.616,
...
function notify(_ref2) {
  ...
  var toastId = toast( /*#__PURE__*/React__default.createElement(ToastNotificationComponent, {
...
var StyledContainer = styled(ToastContainer)(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteralLoose(["\n  &.Toastify__toast-container {\n    max-width: 450px;\n    min-width: 300px;\n    padding: 0px;\n    width: unset;\n  }\n\n  .Toastify__toast-theme--light,\n  .Toastify__toast-theme--default,\n  .Toastify__toast-theme--dark {\n    padding: 0px;\n    border-radius: 5px;\n    background-color: transparent;\n  }\n\n  .Toastify__toast-body {\n    padding: 0px;\n  }\n"])));
...
var InboxContext$1 = createContext({
...
function SuprSendProvider(_ref) {
  ...
  var _useState2 = useState(_extends({}, initialNotificationData)),
...
function useNotifications(storeId) {
  ...
  var inboxData = useContext(InboxContext$1);
...
export { SuprSendProvider, useBell, useEvent, useNotifications, useStoreUnseenCount, useStoresUnseenCount, useUnseenCount };
