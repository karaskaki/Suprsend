...
// import { subscriber_id } from "../suscriberId";
import {
  FaBars,
  // FaDribbble,
  // FaFacebook,
...
export default function Header() {
  ...
  // const subscriber_Id = subscriber_id({ distinct_id: "Nikhil" });
    ...
    <header className="bg-black text-white fixed top-0 left-0 right-0 z-50">
      <nav className="px-4 py-4 max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="text-white lg:flex gap-4 item-center hidden">
          <SuprSendInbox
            theme={{ bell: { color: "orange" } }}
            workspaceKey="bIvjKIXCigGQE76hnkdv"
            subscriberId="oDF7_0xsR__R6Td9sZpgxWFnGBjRKPfC4mlY0Xt5uzI"
            distinctId="Nikhil"
          />
        </div>
